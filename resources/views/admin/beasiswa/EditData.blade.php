    ...
    <div>
        ...
        <div class="mb-16 max-w-sm min-w-full px-6 py-5 pt-7 bg-white rounded-lg shadow border-l-8 border-l-sky-400 border border-gray-200">
            ...
            <div class="w-full text-end">
                <a href="{{ route('Instansi.Selection') }}?IdObject={{ $DataBeasiswa->id }}&IdInstansi={{ $DataInstansi->id }}&ChangeInstansi=true&Beasiswa=True" class="text-blue-500 font-medium text-[13px] hover:underline">
                    Ganti Instansi
                </a>
            </div>
        </div>
