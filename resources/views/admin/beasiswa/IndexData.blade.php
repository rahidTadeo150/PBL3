...
@section('Content')
    ...
    <p class="text-sm font-normal text-gray-700">Daftar beasiswa yang telah terposting</p>
        ...
        <form action="{{ route('Beasiswa.Index') }}" method="get">
            ...
            <div class="flex flex-row gap-x-3">
                ...
                <div class="relative bg-[#3A3838] px-[15px] w-[140px] h-[41px] rounded-md">
                    <div id="ButtonFilter" onclick="ShowDropdown()" class="flex flex-row items-center justify-between w-full h-full">
