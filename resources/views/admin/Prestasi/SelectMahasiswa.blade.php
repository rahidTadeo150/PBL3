...
<p class="text-sm font-normal text-gray-700">Pilih Mahasiswa Untuk Informasi Prestasi Yang Akan Di Input</p>
...
<p class="mt-10 mb-3 text-sm text-slate-800">Data Yang Ditemukan : {{ $TotalDatas }}</p>
