...
@section('Content')
    <div>
        <p class="text-2xl font-semibold">Form Mahasiswa Berprestasi</p>
        <p class="text-sm text-gray-700 font-normal">Form Pengisian Data Mahasiswa Berprestasi Lobi Poliwangi</p>
        ...
        <div class="mb-16 max-w-sm min-w-full px-6 py-5 pt-7 bg-white rounded-lg shadow border-l-8 border-l-sky-400 border border-gray-200">
            <div class="flex flex-row items-center gap-x-5">
                <div class="w-[60px] h-[60px] bg-black rounded-full overflow-hidden">
                    <img src="\storage\{{ $DataMahasiswa->foto_mahasiswa }}">
                </div>
                <div>
            ...
            <div class="w-full text-end">
                <a href="{{ route('Prestasi.MahasiswaSelect') }}" class="text-blue-500 font-medium text-[13px] hover:underline">
                    Ganti Mahasiswa
                </a>
            </div>
        </div>
                ...
                <div class="flex flex-row justify-between items-center px-5">
                    <div>
                        ...
                        <div class="relative z-0 w-96 mb-5">
                            <input name="NamaPerlombaan" value="{{ old('NamaPerlombaan') }}" autocomplete="off" type="text" id="floating_standard" class="mb-[5px] block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                        ...
                        <div class="relative z-0 w-96 mb-9">
                            <input name="UrutanPrestasi" value="{{ old('UrutanPrestasi') }}" autocomplete="off" type="text" id="floating_standard" class="mb-[5px] block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                        ...
                        <div class="relative z-0 w-80 mb-9">
                            <select name="CategoryPerlombaan" autocomplete="off" type="date" id="floating_standard" class="mb-[5px] block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                <option value="" selected> - Pilih Kategori Perlombaan - </option>
                                @foreach ($Category as $Category)
                                <option value="{{ $Category->id }}" class="text-sm font-normal pl-2 pr-2">{{ $Category->category }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="relative z-0 w-80 mb-9">
                            <select name="Tingkatan" autocomplete="off" type="date" id="floating_standard" class="mb-[5px] block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                <option value="" selected> - Pilih Tingkatan Perlombaan - </option>
